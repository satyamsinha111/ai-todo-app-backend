 ...
 */
const createVerificationEmailTemplate = (firstName: string, verificationUrl: string): string => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
export const sendVerificationEmail = async (
  ...
  try {
    ...
    const htmlContent = createVerificationEmailTemplate(firstName, verificationUrl);
 ...
 * @returns Promise that resolves if email configuration is working
 */
